        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            animation: 'fadeInUp 0.8s ease-out forwards'
                ...
                {index < steps.length - 1 && <div className="md:hidden absolute -bottom-6 left-1/2 transform -translate-x-1/2 w-0.5 h-6 bg-gradient-to-b from-emerald-500/50 to-transparent"></div>}
